...
model_path = "/home/weixuan/Documents/Code/blenderproc/model/model_2022_12_26_18_14_17.pt"

num_classes = 4
model = ml.get_object_detector_model(num_classes, device)
model.load_state_dict(torch.load(model_path))
model.eval()

#visualization
# img_path = "/home/weixuan/Documents/Code/blenderproc/data/annotation/images/000019.jpg"
img_path = "/home/weixuan/Documents/Code/blenderproc/target_images/006.png"
...
text_size=1
text_th=1
pred_class = [class_names[i] for i in list(predictions[0]['labels'].cpu().numpy())]
pred_boxes = [[(int(i[0]), int(i[1])), (int(i[2]), int(i[3]))] for i in list(predictions[0]['boxes'].detach().cpu().numpy())]
